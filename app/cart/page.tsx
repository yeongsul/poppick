          ...
          <div className="p-6">
            {items.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 mb-6">관심있는 상품을 장바구니에 담아보세요!</p>
                <button
                  onClick={() => router.push('/')}
                ...
                <div className="border-t border-gray-200 pt-6">
                  <div className="bg-gray-50 rounded-xl p-6">
                    <div className="flex justify-between items-center mb-4">
                      <span className="text-lg font-medium text-gray-700">총 {items.reduce((sum, item) => sum + item.qty, 0)}개 상품</span>
